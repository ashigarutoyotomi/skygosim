<template>
    <div id="inventory-physical-sims">
        ...
        <template v-if="!loading">
            <div class="internet-packages bg-white shadow-sm rounded-lg py-4 px-4">
                ...
                <template v-if="data.data.length">
                    <pagination
                        :data="data"
                        load-event="inventory-physical-sims.load"
                    />
                </template>
            </div>
        </template>
...
<script>
    ...
    export default {
        ...
        created() {
            this.$root.$on('inventory-physical-sims.load', this.loadData);

            this.loadData();
        },

        beforeDestroy() {
            this.$root.$off('inventory-physical-sims.load', this.loadData);
        },
