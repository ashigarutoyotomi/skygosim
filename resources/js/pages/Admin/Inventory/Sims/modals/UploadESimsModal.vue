<template>
    ...
    >
        <div class="container p-4">
            <div class="row mb-4">
                <div class="col-11">
                    <h5 class="modal-title">Upload E-SIMs</h5>
                </div>
                <div class="col-1">
            ...
            <div class="row mb-4">
                <div class="col-12">
                    <label for="fileInput" class="form-label">Select  e-SIMs file</label>
                    <input
...
<script>
    export default {
        name: "UploadESimsModal",

        data() {
            return {
                modalId: 'UploadESimsModal',
                form: {
                    file: null
                },
                loading: false,
            ...
            save() {
                ...
                axios.post('/sims/upload-file', formData)
                    .then(({data}) => {
                        ...
                        this.$root.$emit('inventory-e-sims.load');

                        this.$toast.open({
                            message: 'E-SIMs uploaded',
                            type: 'success',
