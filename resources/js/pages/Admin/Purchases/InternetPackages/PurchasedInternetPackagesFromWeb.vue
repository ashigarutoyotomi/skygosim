...
export default {
    name: "PurchasedInternetPackagesFromWeb",
    ...
    created() {
        this.$root.$on('purchased-internet-packages-from-web.load', this.loadData);

        this.loadData();
    },

    beforeDestroy() {
        this.$root.$off('purchased-internet-packages-from-web.load', this.loadData);
    },
    ...
    methods: {
        loadData(data) {
            ...
            axios.get(`/purchases/internet-packages-from-web`, {
                params
            })
                .then(({data}) => {
                    this.data = data;
